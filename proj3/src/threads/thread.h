...
struct thread
  {
    ...
    struct hash sup_page_table;         /* Supplemental Page Table implementation */
    struct mapped_entry *mapped_item;    /* Mapped item in process. */
#endif
...
struct thread *get_thread_by_id (tid_t id);
